...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "GiffitsStarterKit" do |machine_id|
      ...
      # argument is a set of non-required options.
       machine_id.vm.synced_folder ".", "/var/www", type: "smb", smb_username: "TeamQuito8" ,smb_password: "TeamGroupEcu", :mount_options => ["mfsymlinks,dir_mode=0777,file_mode=0777,vers=3.0"]
       machine_id.vm.synced_folder ".", "/vagrant", type: "smb", smb_username: "TeamQuito8" ,smb_password: "TeamGroupEcu", :mount_options => ["mfsymlinks,dir_mode=0777,file_mode=0777,vers=3.0"]
